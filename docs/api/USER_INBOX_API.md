...
| `collaboration` | `PROJECT_COMMENT_ADDED`, `PROJECT_COMMENT_MENTION`, `PRESENTATION_COMMENT_ADDED`, `PRESENTATION_COMMENT_MENTION`, `PROJECT_ASSIGNED`, `PROJECT_UNASSIGNED` |
