...
- **Stock media (Pexels)** – `PEXELS_API_KEY` (required for `/api/stock/*`). Optional `STOCK_PHOTO_MAX_BYTES` (default 15 MB), `STOCK_VIDEO_MAX_BYTES` (default 100 MB). See [`STOCK_API.md`](STOCK_API.md).
