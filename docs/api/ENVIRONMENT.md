...
- **Image Gen (OpenAI)** – uses `OPENAI_API_KEY`. Optional AC: `IMAGE_GEN_GPT_IMAGE_AC` (default 6), `IMAGE_GEN_GPT_IMAGE_HD_AC` (12), `IMAGE_GEN_DALL_E_3_AC` (8), `IMAGE_GEN_INFOGRAPHIC_SURCHARGE_AC` (2), `IMAGE_GEN_SOCIAL_SURCHARGE_AC` (1). Rate limits: `IMAGE_GEN_RATE_LIMIT_MAX` (30), `IMAGE_GEN_RATE_LIMIT_WINDOW_SEC` (3600), `IMAGE_GEN_REGENERATE_RATE_LIMIT_MAX` (60), `IMAGE_GEN_REGENERATE_RATE_LIMIT_WINDOW_SEC` (3600). See [`IMAGE_GEN_API.md`](IMAGE_GEN_API.md).
