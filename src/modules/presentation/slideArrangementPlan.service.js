...
const ARCHETYPES = {
  general: {
    ...
    preferredLayouts: {
      ...
      bullet_list: ['four_para_image_v1', 'intro_four_para_v1', 'bullet_list_cards_v1', 'intro_three_para_icons_v1', 'bullet_list_dense_v1'],
      stat: ['metric_single_v1', 'metric_three_v1', 'metric_four_v1'],
      chart: ['chart_with_description_v1', 'chart_two_v1', 'grid_insights_chart_v1'],
      ...
      closing: ['closing_thank_you_v1', 'closing_contact_cta_v1', 'centered_text_cta_v1', 'para_image_cta_v1'],
    },
  },
  pitch: {
    id: 'pitch',
    ...
    preferredLayouts: {
      ...
      diagram: ['diagram_funnel_v1', 'diagram_process_steps_v1', 'diagram_matrix_v1'],
      ...
      closing: ['closing_contact_cta_v1', 'closing_thank_you_v1', 'centered_text_cta_v1'],
    },
  },
  educational: {
    id: 'educational',
    ...
    preferredLayouts: {
      ...
      bullet_list: ['intro_four_para_v1', 'four_para_image_v1', 'bullet_list_numbered_v1'],
    },
  },
  product: {
    id: 'product',
