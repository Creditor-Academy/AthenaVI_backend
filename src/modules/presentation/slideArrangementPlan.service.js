...
const ARCHETYPES = {
  general: {
    ...
    preferredLayouts: {
      ...
      timeline: ['timeline_milestones_image_v1', 'timeline_milestones_v1', 'timeline_roadmap_v1', 'timeline_process_steps_v1', 'timeline_horizontal_v1'],
  ...
  pitch: {
    ...
    preferredLayouts: {
      ...
      timeline: ['timeline_milestones_image_v1', 'timeline_milestones_v1', 'timeline_roadmap_v1'],
