function buildSystem() {
  return [
    ...
    '- subject must be a photographic scene/object (≤20 words). NEVER quote or paste slide title/body/paragraph text into subject.',
    '- NEVER put readable text, captions, headlines, logos, watermarks, or UI lettering in the image',
    '  (device mockup UI screenshots are the only exception when DEVICE_IMAGE is requested).',
    ...
    '  ignore it. Still strip any pasted paragraph copy into a visual metaphor.',
    '',
