function buildSystem() {
  return [
    ...
    'Linear 2–5 step how-it-works / workflow / pipeline slides: content_type "diagram" and visual_need "diagram_template". NEVER path_b for those.',
...
function buildUser(vars = {}) {
  ...
  return [
    ...
    'Pick diagram + visual_need diagram_template for numbered workflows / how-it-works, SWOT, funnel, matrix, cycle.',
