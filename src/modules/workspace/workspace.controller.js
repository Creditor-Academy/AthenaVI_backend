...
const inviteMember = asyncHandler(async (req, res) => {
  ...
  await workspaceService.inviteMember(workspaceId, inviterId, email, role);
  return successResponse(req, res, {}, 201, messages.WORKSPACE_INVITE_SENT);
});
...
const getWorkspaceInvitations = asyncHandler(async (req, res) => {
  ...
  return successResponse(req, res, { invitations }, 200, messages.WORKSPACE_INVITATIONS_FETCHED);
});
...
const cancelInvitation = asyncHandler(async (req, res) => {
  ...
  return successResponse(
    ...
    result,
    200,
    messages.WORKSPACE_INVITE_CANCELLED
  );
});
