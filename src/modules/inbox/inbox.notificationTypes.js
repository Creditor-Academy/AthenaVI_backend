...
const TYPE_CATEGORY = {
  ...
  PRESENTATION_EXPORT_COMPLETED: CATEGORIES.PRESENTATIONS,
  PRESENTATION_EXPORT_FAILED: CATEGORIES.PRESENTATIONS,
  PRESENTATION_GENERATION_COMPLETED: CATEGORIES.PRESENTATIONS,
  PRESENTATION_GENERATION_FAILED: CATEGORIES.PRESENTATIONS,
  PRESENTATION_COMMENT_ADDED: CATEGORIES.COLLABORATION,
  PRESENTATION_COMMENT_MENTION: CATEGORIES.COLLABORATION,
  PROJECT_ASSIGNED: CATEGORIES.COLLABORATION,
  PROJECT_UNASSIGNED: CATEGORIES.COLLABORATION,
  SLIDE_ASSIGNED: CATEGORIES.COLLABORATION,
  SLIDE_UNASSIGNED: CATEGORIES.COLLABORATION,
  SCENE_ASSIGNED: CATEGORIES.COLLABORATION,
  SCENE_UNASSIGNED: CATEGORIES.COLLABORATION,
};
...
const TYPE_PREFERENCE_KEY = {
  ...
  PRESENTATION_EXPORT_COMPLETED: 'videoExportAlerts',
  PRESENTATION_EXPORT_FAILED: 'videoExportAlerts',
  PRESENTATION_GENERATION_COMPLETED: 'videoExportAlerts',
  PRESENTATION_GENERATION_FAILED: 'videoExportAlerts',
  PRESENTATION_COMMENT_ADDED: 'commentsAndMentions',
  PRESENTATION_COMMENT_MENTION: 'commentsAndMentions',
  PROJECT_ASSIGNED: 'workspaceTeamAlerts',
  PROJECT_UNASSIGNED: 'workspaceTeamAlerts',
  SLIDE_ASSIGNED: 'workspaceTeamAlerts',
  SLIDE_UNASSIGNED: 'workspaceTeamAlerts',
  SCENE_ASSIGNED: 'workspaceTeamAlerts',
  SCENE_UNASSIGNED: 'workspaceTeamAlerts',
};
